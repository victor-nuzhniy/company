...
import jwt
from flask import Request, abort, current_app, request, typing
...
class TokenFunctionality(object):
    ...
    def get_current_user(self, token: str) -> Any | None:
        """Get current base from token data."""
    ...
    def check_current_user(
        ...
        if not current_user.is_active:
            abort(403, "Current base is not active.")
        if is_admin and not current_user.is_admin:
            abort(403, "Current base is not admin.")
...
def token_required(is_admin: bool = False) -> Callable:
    ...
    def decorator_factory(func: Callable) -> Callable:  # noqa WPS430
        @wraps(func)
        def decorated(  # noqa WPS430
            *args: Any,
            **kwargs: Any,
        ) -> typing.ResponseReturnValue:  # noqa WPS430
...
class ModelRoute(Resource):
    ...
    def patch(
        ...
        *args: Any,
        **kwargs: Any,
    ) -> typing.ResponseReturnValue:  # TODO add token_decorator to all
...
class ModelsRoute(Resource):
    ...
    def post(self, *args: Any, **kwargs: Any) -> typing.ResponseReturnValue:
    ...
    def get(self, *args: Any, **kwargs: Any) -> typing.ResponseReturnValue:
