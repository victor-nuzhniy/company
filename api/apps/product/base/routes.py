"""Routes for product base apps."""
import typing

from flask.typing import ResponseReturnValue
from flask_restful_swagger import swagger

from api import Product, ProductType, api
from api.apps.product.base.parsers import (
    product_parser,
    product_patch_parser,
    product_type_parser,
    product_type_patch_parser,
)
from api.apps.product.base.schemas import (
...
from api.apps.product.base.swagger_models import ProductFields, ProductTypeFields
