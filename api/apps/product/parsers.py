...
from api.apps.invoice.validators import product_id, str_length_100
from api.apps.product.validators import str_length_15, str_length_200
...
product_type_parser.add_argument("product_id", type=product_id, required=True)
...
product_type_patch_parser.add_argument("product_id", type=product_id, required=False)
