...
from api.apps.order_specialized import parsers, schemas, services, swagger_models
...
class UserOrderRoute(Resource):
    ...
    def post(self, *args: typing.Any, **kwargs: typing.Any) -> ResponseReturnValue:
        ...
        current_user: typing.Optional[user_models.User] = kwargs.get("current_user")
        if current_user:
            arguments["user_id"] = current_user.id
            return marshal(
                api_services.crud.create(order_models.Order, arguments),
