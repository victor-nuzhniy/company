...
order_product_parser.add_argument("product_id", type=product_id, required=False)
order_product_parser.add_argument("quantity", type=int, required=False)
order_product_parser.add_argument("price", type=int, required=False)
order_product_parser.add_argument("order_id", type=order_id, required=False)
